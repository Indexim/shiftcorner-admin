...
{
    public class SettingFleetUnitSupportController : Controller
    {
        private readonly AppDBContext _context;
        private readonly ILogger<SettingFleetUnitSupportController> _logger;
        private string controller_name = "SettingFleetUnitSupport";
        private string title_name = "SettingFleetUnitSupport";
        ...
        public SettingFleetUnitSupportController(AppDBContext context, ILogger<SettingFleetUnitSupportController> logger)
        {
            _context = context;
            _logger = logger;
        }
            ...
            try
            {
                ...
                <div id='{loader.loader}' class='hauler' style='width: 200px; margin: 0 10px; padding-bottom:100px;' ondragover='onDragOver(event);' ondrop='onDrop(event);'>");
                    ...
                    var resultHauler = _context.vw_t_setting_fleet
                        .Where(x => x.loader == loader.loader && (x.cn_unit.Contains("DT") || x.cn_unit.Contains("DZ") || x.eq_class == "GD"))
                          .Distinct()
                        .OrderBy(x => x.hauler)
                        .ToList();
            ...
            try
            {
                var resultUnit = _context.vw_t_setting_fleet
                    .Where(x =>
                                ...
                                (x.eq_class == "LD" || x.eq_class == "DZ" || x.eq_class == "GD"))
                    .Distinct()
