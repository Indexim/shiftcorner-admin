...
namespace Embarkasi.Controllers
{
    public class DeptController : Controller
    {
        ...
        public IActionResult GetAll()
        {
            try
            {
                var data = _context.tbl_r_depts.OrderBy(x => x.created_at).ToList();
        ...
        public IActionResult Get(int id)
        {
            try
            {
                var result = _context.tbl_r_depts.Where(x => x.id == id).FirstOrDefault();
        ...
        public ActionResult Update(tbl_r_dept a)
        {
            try
            {
                var tbl_ = _context.tbl_r_depts.FirstOrDefault(f => f.id == a.id);
                if (tbl_ != null)
                {
                    tbl_.id = a.id;
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                var tbl_ = _context.tbl_r_depts.FirstOrDefault(f => f.id == id);
                if (tbl_ != null)
                {
                    _context.tbl_r_depts.Remove(tbl_);
                    _context.SaveChanges();
