...
{
    public class Display1Controller : Controller
    {
        private readonly AppDBContext _context;
        private readonly ILogger<Display1Controller> _logger;
        private string controller_name = "Display1";
        private string title_name = "Display1";



        public Display1Controller(AppDBContext context, ILogger<Display1Controller> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public IActionResult GetAll()
        {
            try
            {
                var data = _context.vw_m_notifikasi_finger
