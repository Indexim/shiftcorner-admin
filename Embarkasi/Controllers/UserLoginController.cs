...
namespace Embarkasi.Controllers
{
    public class UserLoginController : Controller
    {
        ...
        public UserLoginController(AppDBContext context, ILogger<UserLoginController> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        [Authorize]
        [HttpPost]
        public IActionResult Insert(tbl_m_user_login a)
        {
            try
            {
        ...
        public ActionResult Update(tbl_m_user_login a)
        {
            try
            {
                var tbl_ = _context.tbl_m_user_login.FirstOrDefault(f => f.id == a.id);
                if (tbl_ != null)
                {
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                var tbl_ = _context.tbl_m_user_login.FirstOrDefault(f => f.id == id);
                if (tbl_ != null)
                {
